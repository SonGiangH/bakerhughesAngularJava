package com.example.bakerhughesapp.controllers;

import com.example.bakerhughesapp.dtos.SurveyDTO;
import com.example.bakerhughesapp.models.ResponseObject;
import com.example.bakerhughesapp.models.Sliding;
import com.example.bakerhughesapp.models.Survey;
import com.example.bakerhughesapp.repositories.SurveyRepository;
import com.example.bakerhughesapp.services.ISurveyService;
...
public class SurveysController {
    ...
    public List<Survey> calculateSurvey(List<Survey> surveys) {
        ...
        for (Survey survey : surveys) {
            ...
            // Bit depth (sensor depth = 16)
            survey.setBitDepth(survey.getSurveyDepth() + 16);
            if (item != null) {
